...
{
    public class EfWalletTransactionRepository : EfEntityRepositoryBase<WalletTransaction>, IWalletTransactionRepository
    {
        public EfWalletTransactionRepository(DbContext context) : base(context)
        {
        }
    }
}
